...
public final class Sort {
    ...
    private static void sort(int[] a, int lo, int hi) { 
        ...
        SortSounds.drawRectangle(StdDraw.DARK_GRAY, j);
        sort(a, lo, j-1);
        sort(a, j+1, hi);
    }
    ...
    private static void exch(int[] a, int index1, int index2) {
        ...
        SortSounds.drawRectangle(StdDraw.MAGENTA, index1);
        StdDraw.show(5);

        SortSounds.clearRectangle(index2);
        StdDraw.show(5);

        SortSounds.drawRectangle(StdDraw.MAGENTA, index2);
        StdDraw.show(5);
        ...
        SortSounds.drawRectangle(StdDraw.YELLOW, index2);
        StdDraw.show(5);       
    }
