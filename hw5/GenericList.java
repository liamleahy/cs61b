...
public class GenericList<Thingy> {
    ...
    /** Returns a Thingy representation of this list of the form:
     *  [item1, item2, ..., itemN]. */
    @Override
